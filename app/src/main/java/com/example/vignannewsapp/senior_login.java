...
public class senior_login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(snapshot.hasChild(phone))
                            {
                                ...
                                if((username1.equals(username)) && (password2.equals(password)))
                                {
                                    ...
                                    Intent intent = new Intent(senior_login.this, MainActivity.class);
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(senior_login.this,senior_register.class));
            }
        });
    }
}