...
public class senior_register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senior_register);
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(senior_register.this,senior_login.class));
            }
        });
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(!isValid(password))
                {
                    ...
                    databaseReference.child("Senior").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            //check if email is nor registered before or not
                            if(snapshot.hasChild(phone))
                            {
                                Toast.makeText(senior_register.this,"Phone number already registered",Toast.LENGTH_SHORT).show();
                            }
                            else {
                                //sending data to firebase realtime database
                                databaseReference.child("Senior").child(phone).child("Username").setValue(username);
                                databaseReference.child("Senior").child(phone).child("Password").setValue(password);
                                databaseReference.child("Senior").child(phone).child("Email").setValue(email);
                                Toast.makeText(senior_register.this,"senior Registered Successfully",Toast.LENGTH_SHORT).show();
                            }
                        }
